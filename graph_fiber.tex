...
\begin{document}
  ...
  \begin{tikzpicture}[node distance=3cm,thick,scale=0.4, every node/.style={scale=0.4},path image/.style={
    ...
    \end{pgfonlayer}
    \path (seg.north) +(0,+\blockdist) node (bgreg) {\Large Pre-processing};
